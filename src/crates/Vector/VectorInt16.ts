...
export class VECTOR_INT16 {
  ...
  fit() {
    let n: Int16Array | null = new Int16Array(this.count);
  ...
  push(val: number) {
    if (this.capacity < this.count + 1) {
      let n: Int16Array | null = new Int16Array(2 * this.capacity + 1);
  ...
  concat(array: VECTOR_INT16) {
    const v8 = new VECTOR_INT16();
    for (let i = 0; i < this.count; ++i) {
...
export const VectorInt16 = (...nums: any[]) => new VECTOR_INT16(...nums);
